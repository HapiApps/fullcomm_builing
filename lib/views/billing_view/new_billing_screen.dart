...
class _NewBillingScreenState extends State<NewBillingScreen> {
    ...
    return Consumer3<UserDataProvider,CustomersProvider,BillingProvider>(
        builder: (context, userDataProvider, customerProvider, billingProvider, _) {
          return Shortcuts(
              ...
              LogicalKeySet(LogicalKeyboardKey.alt, LogicalKeyboardKey.keyP): const ActivateIntent(),
              LogicalKeySet(LogicalKeyboardKey.control, LogicalKeyboardKey.keyP): const ActivateIntent(),
              LogicalKeySet(LogicalKeyboardKey.alt, LogicalKeyboardKey.keyS): const NextPageIntent(),
              LogicalKeySet(LogicalKeyboardKey.alt, LogicalKeyboardKey.keyR): const LastBillIntent(),
              ...
              child: Actions(
                actions: {
                            ...
                            onPressPrint: (){
                              ...
                              billingProvider.placeOrderAndPrintBill(
                                ...
                                order: Order(
                                    ...
                                    receivedAmt: billingProvider.paymentReceived.text.isEmpty?"0.0":double.parse(billingProvider.paymentReceived.text).toStringAsFixed(1),
                                    payBackAmt:(((billingProvider.paymentReceived.text.isEmpty? 0.0:double.parse(billingProvider.paymentReceived.text))
                                        -billingProvider.calculatedGrandTotal()).abs().toStringAsFixed(2)),
                  ...
                  NextPageIntent: CallbackAction<NextPageIntent>(
                    onInvoke: (intent) {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const OrderDetailPage()));
                      return null;
                    },
                  ),
              ...
              child: PopScope(
                ...
                child: Scaffold(
                  ...
                  body: GestureDetector(
                    ...
                    child: billingProvider.isLoading ? LoadingWidgets.circleLoading()
                        : Column(
                            ...
                            Padding(
                              ...
                              MyTextField(
                                ...
                                onEditingComplete: (){
                                  ...
                                  try {
                                    final product = billingProvider.productsList.firstWhere((p) => p.barcode == billingProvider.barcodeScanner.text);

                                    billingProvider.selectedProduct = product;
                                    billingProvider.barcodeScanner.text = "${billingProvider.selectedProduct!.pTitle.toString()} ${billingProvider.selectedProduct!.pVariation.toString()}${billingProvider.selectedProduct!.unit.toString()}";
                                  ...
                                  IconButton(
                                      tooltip: billingProvider.barcodeMode ? 'Search Products' : 'Scan Products',
                                      onPressed: (){
                                        //controller.barcodeMode.value = !controller.barcodeMode.value;
                                        billingProvider.barcodeModeChange();
                                        print("scan ${billingProvider.barcodeMode}");
                                      },
                                      icon: billingProvider.barcodeMode ?  const Icon(Icons.search,color: Colors.grey) :
                                      const Icon(Icons.barcode_reader,color: Colors.grey)
                                  ),
                                  10.width,
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: billProduct.product.isLoose == '1'
                                                        ? _buildEditableCell(
                                                        index: index,
                                                        //controller: TextEditingController(text: "${billProduct.variation/1000}",),
                                                        controller: TextEditingController(text: "${billProduct.variation/1000}",),
                                                        onChanged: (value) {
                                                        //billingProvider.changeVariation(value);
                                                          billingProvider.updateBillingItem(
                                                            index,
                                                            isLoose: '1',
                                                            variation: double.tryParse(billingProvider.variation) ?? billProduct.variation * 1000,
                                                          );
                                                        },
                                                        onEditingComplete: (){
                                                        ...
                                                        : _buildCell(billProduct.variationUnit=="nullnull"?"":
                    ...
                    child: Row(
                      ...
                      children: [
                        BottomWidgets.valueCard(context: context,
                            title: 'Items', value: billingProvider.calculatedTotalProducts().toString()),
  ...
  Future<void> showPaymentBalanceDialog(
      BuildContext context, {required void Function() onPressPrint,}) async {
