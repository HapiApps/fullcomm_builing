  ...
  void showDatePickerDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return StatefulBuilder( // to update state inside dialog
                        ...
                        children: [
                          Radio<String>(
                            ...
                            onChanged: (value) {
                              billingProvider.changeDateFilter(value!);
                              DateTime today = DateTime.now();
                              DateTime end = today.subtract(const Duration(days: 7));
                              String todayStr = DateFormat('yyyy-MM-dd').format(today);
                              String endStr = DateFormat('yyyy-MM-dd').format(end);
                              billingProvider.getAllOrderDetails(endStr, todayStr);
                              billingProvider.setDateRange(null);
                            ...
                            child: DataTable(
                              ...
                              rows: billingProvider.allOrders
                                ...
                                return DataRow(
                                    ...
                                    if (products.isNotEmpty && products[0] != "null") {
                                      showDialog(
                                        ...
                                        builder: (context) => AlertDialog(
                                          title: const MyText(text: "Products",
                                            fontSize: 20,
                                            fontWeight: FontWeight.bold,
                                          ),
                                          content: SizedBox(
                                            ...
                                            child: ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                print("Unit: ${productsUnit[index]}");
                                                return Padding(
                                                  padding: const EdgeInsets.symmetric(vertical: 4),
                                                  child: Text("${products[index]} ${productsUnit[index]}", style: const TextStyle(color: Colors.black)),
                                                );
                                              },
                                            ),
                                          ),
                                  ...
                                  cells: [
                                    DataCell(Text(billingProvider.formatDate(data.oDate.toString()))),
                                    DataCell(Text(data.invoiceNo.toString())),
                                    DataCell(Text(data.name.toString() == "Cash" ? "-" : data.name.toString())),
                                    DataCell(
                                        Text(
                                data.name.toString() == "Cash" ? "-" : data.mobile.toString())),
                                    DataCell(
                                        SizedBox(
                                          //color : Colors.red,
                                          width : 80,
                                    ...
                                    DataCell(
                                      ...
                                      children: [
                                                  ...
                                                  content: SizedBox(
                                                    ...
                                                    child: ListView.builder(
                                                      ...
                                                      itemBuilder: (context, index) {
                                                        return Padding(
                                                          padding: const EdgeInsets.symmetric(vertical: 4),
                                                          child: Text("${products[index]} ${productsUnit[index]}", style: const TextStyle(color: Colors.grey)),
                                                        );
                                                      },
                                                    ),
                                                  ),
                                        ...
                                        ElevatedButton(
                                          ...
                                          child: const Text("Print", style: TextStyle(color: Colors.white, fontSize: 12)),
                                        ),
                                      ],
                                    )),
                                  ],
