...
// class AppColors {
//
//   static const Color primary              = Color(0xFF770FA0);
//   static const Color secondary            = Colors.white;
//   static const Color introTitleTxtColor   = Color(0xFF16325B);
//   static const Color introSubTitleColor   = Color(0xFF003161);
//   static const Color textFieldBackground  = Color(0xFFF3F6FA);
//   static const Color shimmerHighlight     = Color(0xFFFCFCFC);
//   static const Color shimmerBase          = Color(0xFFF4F3F3);
//   static const Color appAccentColor            = Color(0xffC62E2E);
//   //static const  Color darkPrimary         = Color(0xFF000B58);
//   static const  Color darkPrimary         = Color(0xFF42035C);
//   static  Color discountBadge             = primary.withOpacity(0.45);
//   static const Color selectedCoupon       = Color(0xffE6F4EA);
//   static const Color transparent          = Colors.transparent;
//
//   static const Color white          = Colors.white;
